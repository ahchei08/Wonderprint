...
show_help() {
    ...
    echo ""
    echo "Build Wonderprint-Orca as a Flatpak package"
    echo ""
    echo "Options:"
...
echo -e "${BLUE}Wonderprint-Orca Flatpak Build Script${NC}"
echo -e "${BLUE}================================${NC}"
...
BUNDLE_NAME="Wonderprint-Orca-Linux-flatpak_${VER}_${ARCH}.flatpak"
...
if ! flatpak build-bundle \
    "$BUILD_DIR/repo" \
    "$BUNDLE_NAME" \
    io.github.softfever.Wonderprint-Orca \
    --arch="$ARCH"; then
...
echo ""
echo -e "${BLUE}To run Wonderprint-Orca:${NC}"
echo -e "flatpak run io.github.softfever.Wonderprint-Orca"
echo ""
echo -e "${BLUE}To uninstall:${NC}"
echo -e "flatpak uninstall --user io.github.softfever.Wonderprint-Orca"
echo ""
if [[ "$FORCE_CLEAN" != true ]]; then
